<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Masteradmin.master" AutoEventWireup="true" CodeFile="Admindash.aspx.cs" Inherits="Adminash" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Admin" Runat="Server">
    <section>
        <div id="left-column">
          <h3>Quick nav</h3>
          <ul class="nav">
            <li><a href="addprod.aspx">Add a product</a></li>
            <li class="last"><a href="#">Customers</a></li>
          </ul>
          <div class="=link"><p></p><p><a href="#"></a></p><p></p></div>
        </div>
